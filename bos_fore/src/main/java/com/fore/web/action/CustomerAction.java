...
public class CustomerAction extends BaseAction<Customer> {
    ...
    public String customer_activeMail(){
        ...
        if(activeCode==null||!activeCode.equals(activeRedisCode)){
            ...
            Customer customer=WebClient.create("http://localhost:8081/services/customerService/customer/telephone/"+model.getTelephone()).accept(MediaType.APPLICATION_JSON).get(Customer.class);
            if(customer.getType()==null||customer.getType()!=1){
                WebClient.create("http://localhost:8081/services/customerService/customer/updatetype/"+model.getTelephone()).get();
