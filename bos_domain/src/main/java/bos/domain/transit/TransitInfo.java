...
public class TransitInfo {
	...
	public String getTransferInfo(){
		...
		for(InOutStorageInfo inOutStorageInfo:inOutStorageInfos){
			stringBuffer.append(inOutStorageInfo.getDescription()).append("<br />");
		}
		if(deliveryInfo!=null){
			stringBuffer.append(deliveryInfo.getDescription()).append("<br />");
		}
		if(signInfo!=null){
			stringBuffer.append(signInfo.getDescription()).append("<br />");
		}
