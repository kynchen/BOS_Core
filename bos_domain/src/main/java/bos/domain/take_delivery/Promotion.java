...
public class Promotion implements Serializable {
    ...
    public String getTitleImg() {
        ...
        return Constans.BOS_MANAGEMENT_HOST + titleImg;
    }
    ...
    public String getDescription() {
        if(description.contains(Constans.BOS_MANAGEMENT_HOST+"/upload")){
            return description;
        }
        return description.replace("/upload",Constans.BOS_MANAGEMENT_HOST+"/upload");
    }
